...
public class VentanaAyuda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Para realizar los cálculos de un número, selecciónelo en la lista de números y presione \"Calcular\".");

        jLabel2.setText("Para eliminar un número de la lista, selecciónelo y presione \"Eliminar\".");
