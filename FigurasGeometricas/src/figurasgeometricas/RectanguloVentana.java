 ...
 * @author Carolina
 */
public class RectanguloVentana extends javax.swing.JFrame {

    /**
     * Creates new form RectanguloVentana
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RectanguloVentana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RectanguloVentana().setVisible(true);
            }
        });
    }
